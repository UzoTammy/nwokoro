"""
Django settings for nwokoro project.
...
CSRF_TRUSTED_ORIGINS = [
    'https://www.uzonwokoro.com',  # Replace with your domain
    'https://uzonwokoro.com',      # Include non-www if applicable
]
...
DATABASES = {
    'default': {
        'OPTIONS': {'sslmode': 'require' if not os.environ.get('DEBUG_VALUE') == 'True' else 'disable'},
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('DATABASE_NAME'), # The name you used in heroku pg:pull
        'USER': os.getenv('DATABASE_USER'),     # Often your computer username or 'postgres'
        'PASSWORD': os.getenv('DATABASE_PASSWORD'), # Leave as '' if you haven't set one
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
