...
from .views import (
    ...
    ForecastView, ForecastPDFView, ForecastEmailView, NetworthPreferenceView,
    ...
    TutorialListView, TutorialDetailView, TutorialGrowthView, RiskScoreStudyView,
)


urlpatterns = [
    path('', NetworthHomeView.as_view(), name='networth-home'),
    path('history/', NetworthHistoryView.as_view(), name='networth-history'),
    ...
    path('business/<int:pk>/update/', BusinessUpdateView.as_view(),
     ...
     path('business/<int:pk>/re-capitalize/', BusinessReCapitalizeView.as_view(),
         name='networth-business-re-capitalize'),
    ...
    path('forecast/pdf/', ForecastPDFView.as_view(), name='forecast-pdf'),
    path('forecast/email/', ForecastEmailView.as_view(), name='forecast-email'),
    path('preference/', NetworthPreferenceView.as_view(), name='networth-preference'),
    ...
    path('learn/risk-score/', RiskScoreStudyView.as_view(), name='risk-score-study'),
